    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
          ...
          if(tr.getSTATUS().equals("1"))
            ...
            out.print("<div class=\"main-content\">\n"
                    ...
                    + "														<span class=\"editable\" id=\"username\">" + tr.getFNAME()+ " " +tr.getMNAME()+" "+tr.getLNAME()+"</span>\n"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "\n"
                    + "												<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														"
                    + "														<span class=\"editable\" id=\"country\">" + tr.getROLE()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														"
                    + "														<span class=\"editable\" id=\"country\">" + tr.getDISTRICT()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														"
                    + "														<span class=\"editable\" id=\"country\">" + tr.getBRANCH()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "\n" + "<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														"
                    + "														<span class=\"editable\" id=\"country\">" + tr.getNATIONALITY()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "<div class=\"profile-info-row\">\n"
                    ...
                    + "														<span class=\"editable\" id=\"country\">" + tr.getGENDER()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														<i class=\"fa fa-map-marker light-orange bigger-110\"></i>\n"
                    + "														<span class=\"editable\" id=\"country\">" + tr.getPNUM()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "<div class=\"profile-info-row\">\n"
