            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <%                        
                       int acnum = Integer.parseInt(request.getParameter("accnum"));
                            ...
                            Account a = proxy.check(acnum);
                        %>
                        <div class="row">
                            <div class="col-xs-12">
                                <!-- PAGE CONTENT BEGINS -->
                                <form method="get" action="UPDATE_ACC"  class="form-horizontal" id="sample-form">


                                    <input type="hidden" name="accnum"  value=<%=a.getACCNO()%>   class="width-100" required="true"/>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" id="FNAME" name="FNAME"  value=<%=a.getFNAME()%>   class="width-100" required="true"/>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" id="MNAME" name="MNAME" value=<%=a.getMNAME()%>  class="width-100" required="true"/>
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" id="LNAME" name="LNAME"  value=<%=a.getLNAME()%> class="width-100" required="true" />
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select name="GENDER" id="GENDER"  value=<%=a.getGENDER()%>   >
                                                <option >MALE</option>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" id="ADDRESS" name="ADDRESS" value=<%=a.getADDRESS()%>  class="width-100" required="true"/>
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" id="NATIONALITY" NAME="NATIONALITY" value=<%=a.getNATIONALITY()%>  class="width-100" required="true"/>
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" id="OCCUPTION" name="OCCUPTION" value=<%=a.getOCCUPTION()%>  class="width-100" required="true"/>
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" name="DISTRICT" id="DISTRICT" value=<%=a.getDISTRICT()%>  class="width-100" required="true"/>
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" name="BRANCH" id="BRANCH" value=<%=a.getBRANCH()%>  class="width-100" required="true" />
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select name="ACCTYPE" id="ACCTYPE"  value=<%=a.getACCTYPE()%>   >
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" name="BALANCE" id="BALANCE" value=<%=a.getBALANCE()%>  class="width-100" required="true"/>
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" name="PNAME" id="PHONENUMBER" value=<%= a.getPNUM()%>  class="width-100" required="true"/>
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    </div>
