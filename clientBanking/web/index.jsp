<%-- 
    Document   : index
    Created on : Feb 7, 2020, 4:09:34 PM
    Author     : Habib
--%>
...
<html>
    ...
    <body>
	    ...
	    <div class="container">
	      <a class="navbar-brand" href="/">HTK</a>
	        ...
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="#contact-section" class="nav-link"><span>Contact</span></a></li>
                  ...
                  <%
                    if (session.getAttribute("username") != null && session.getAttribute("password") != null) {
                  %>
                        <li class="nav-item"><a href="RedirectorServlet" class="nav-link"><span>Dashboard</span></a></li>
                  <%
                    }
                  %>
	          ...
	          <li class="nav-item cta">
                      <% 
                        if(hreflog == 0){
                            out.write("<a href='#' class='nav-link' data-toggle='modal' data-target='#modalAppointment'>LogIn</a>");
                        }else{
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <p>
                <% 
                    if(hreflog == 0){
                        out.write("<a href='#' class='btn btn-primary py-3 px-4' data-toggle='modal' data-target='#modalAppointment'>LogIn</a>");
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="loginprocess.jsp" method="get">
                <div class="form-group">
                    <input type="text" name="username" class="form-control" placeholder="Username" /><i class="ace-icon fa fa-user"></i>
                </div>
                <div class="form-group">
                ...
                <div class="clearfix">
                    ...
                    <button type="submite" class="width-35 pull-right btn btn-sm btn-primary" style="float: right;">
